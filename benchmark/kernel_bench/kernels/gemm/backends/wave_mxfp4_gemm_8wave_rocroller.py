...
Matches test_dbuf_8wave_pingpong_mxfp_gemm_Bshuffle_lds configuration
from adedespirlet/wave@8wavepingpong:examples/python/7.1_schedule.py.

Compiles wave kernels to assembly via benchmark_mxfp4_8wave.py, integrates
...
# Block matches test_dbuf_8wave_pingpong_mxfp_gemm_Bshuffle_lds: block=(256, 192, 256)
_MACROTILES = [
    (256, 192, 256),
]
...
WAVE_DIR = os.environ.get("WAVE_DIR_WAVE_8WAVE_ROCROLLER", "/workspace/wave-wave_8wave_rocroller")
