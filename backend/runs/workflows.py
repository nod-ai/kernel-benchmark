...
This module contains workflow metadata and lookup functions.
All workflow dispatch logic has been moved to trigger_service.py.

This module ONLY contains:
- WorkflowRunInfo dataclass
- SUPPORTED_WORKFLOWS list
- find_workflow() lookup function
"""
